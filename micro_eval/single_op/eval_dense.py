...
class DummyCMod:
    ...
    def export_library(self, out_obj_path, fcompile=None):
        ...
        fcompile(out_obj_path, f'{os.path.dirname(__file__)}/cmsis_dense.c')
...
def eval_dense():
    ...
    def run_cmsis_dense(sess, data_tvm, weight_tvm, bias_tvm):
        ...
        for _ in range(NUM_TRIALS):
            micro_func(data_tvm, weight_tvm, bias_tvm, output_tvm)
        ctx.sync()
    ...
    with micro.Session(DEV_CONFIG) as sess:
        ...
        # TODO why are *both* cmsis and micro destroying input tensors?
        # TODO try it with just 1 trial each?
